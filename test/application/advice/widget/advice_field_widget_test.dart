import 'package:custom_theme/presentation/advice/widgets/advice_field.dart';
  ...
  Widget widgetUnderTest({required String adviceText}){
   ...
   group('AdviceField',(){
    group('should be displayed correctly', () {
      ...
      const text='Hello flutter developers, i hope you enjoy the course, and have a great time. The sun is shining, i have no idea what else i should write here to get a very long text.';
      await widgetTester.pumpWidget(widgetUnderTest(adviceText: text));
      await widgetTester.pumpAndSettle();
     ...
     testWidgets('when no text is given', (widgetTester)async{
      ...
      final adviceFieldFinder=find.text(text);
